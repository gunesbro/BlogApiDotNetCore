...
namespace BlogProjectAPI.Middlewares
{
    public class AccessLogger
    {
        ...
        private async Task LogRequest(HttpContext context)
        {
            ...
            accessLogs.RequestBody = string.IsNullOrEmpty(ReadStreamInChunks(requestStream)) ? null : ReadStreamInChunks(requestStream);
        ...
        private async Task LogResponse(HttpContext context)
        {
            ...
            accessLogs.ResponseBody = string.IsNullOrEmpty(text) ? null: text;
